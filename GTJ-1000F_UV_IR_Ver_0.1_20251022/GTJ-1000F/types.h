...
#define __DEF_IINCHIP_MAP_RXBUF__ (COMMON_BASE + 0x6000) /* Internal Rx buffer address of the iinchip */
      ...
      #define IINCHIP_ISR_DISABLE()	(EIMSK &= ~(0x40))	//0100 0000
      #define IINCHIP_ISR_ENABLE()	(EIMSK |= 0x40)
      //#define IINCHIP_ISR_ENABLE()	(EIMSK |= 0x0)
...
#define TX_RX_MAX_BUF_SIZE	1024	//REV15
